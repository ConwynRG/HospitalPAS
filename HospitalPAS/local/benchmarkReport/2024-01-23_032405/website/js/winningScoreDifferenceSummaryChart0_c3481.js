...
var chart_winningScoreDifferenceSummaryChart0_c3481 = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart0_c3481'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart0_c3481.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart0_c3481.resize();
});